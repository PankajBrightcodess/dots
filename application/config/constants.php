...
defined('PROJECT_NAME')        OR define('PROJECT_NAME','DOTS'); 
...
defined('TP')        		   OR define('TP',"dot_"); // Table Prefix
...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']=='localhost'){
	...
	defined('DB_NAME')		? null : define('DB_NAME','db_dots');
}
else{
	defined('DB_HOST')      ? null : define('DB_HOST', 'localhost');
	defined('DB_USER')      ? null : define('DB_USER', 'softwarebss_dots');
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'DotsThink@2021');
	defined('DB_NAME')      ? null : define('DB_NAME', 'softwarebss_dots');
}